...
def build():
    ...
    # The source already excludes the backing plate. Rotate its thickness onto
    # Z without an in-plane rotation so the locking features remain on +/-X,
    # toward the SD and USB sides.
    ...
    print(f"Mount bounds: {mount_maximum - mount_minimum}")
