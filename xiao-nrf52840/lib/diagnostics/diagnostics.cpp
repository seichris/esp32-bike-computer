...
void Diagnostics::logSnapshot(const char *label,
  ...
  Serial.print(stats.connectCount);
  Serial.print(" disconnect_count=");
  Serial.print(stats.disconnectCount);
  Serial.print(" auth_challenges=");
  Serial.print(stats.authChallengeCount);
  Serial.print(" auth_successes=");
  Serial.print(stats.authSuccessCount);
  Serial.print(" unauth_rejects=");
  Serial.print(stats.rejectedUnauthenticatedCount);
  ...
  Serial.print(" route_total_m=");
  Serial.print(route.totalDistanceMeters);
  ...
  Serial.print(" route_duplicates=");
  Serial.print(stats.routeDuplicateCount);
  Serial.print(" settings_packets=");
  Serial.print(stats.settingsPacketCount);
  Serial.print(" session_nav_packets=");
  Serial.print(stats.sessionNavPacketCount);
  Serial.print(" session_route_packets=");
  Serial.print(stats.sessionRoutePacketCount);
  Serial.print(" session_route_duplicates=");
  Serial.print(stats.sessionRouteDuplicateCount);
  Serial.print(" session_gps_packets=");
  Serial.print(stats.sessionGpsPacketCount);
  Serial.print(" session_settings_packets=");
  Serial.print(stats.sessionSettingsPacketCount);
  ...
  Serial.print(" battery_scale_permille=");
  Serial.print(powerManager.batteryCalibrationPermille());
  Serial.print(" brightness=");
  Serial.print(powerManager.currentBrightness());
  Serial.print(" auto_dim=");
  Serial.print(powerManager.isAutoDimmed());
  Serial.print(" screen_off=");
  Serial.print(powerManager.isScreenOff());
  ...
  Serial.print(" idle_last_screen_off=");
  Serial.print(idleStats.lastScreenOff);
  Serial.print(" idle_last_connected=");
  Serial.print(idleStats.lastConnected);
  Serial.print(" idle_max_ms=");
  Serial.print(idleStats.maxIdleMs);
  Serial.print(" map_enabled=");
  Serial.print(mapStatus.experimentEnabled);
  Serial.print(" map_sd=");
