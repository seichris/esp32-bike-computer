...
struct BLEDebugStats {
  ...
  uint32_t routeDuplicateCount = 0;
  uint32_t gpsPacketCount = 0;
  uint32_t settingsPacketCount = 0;
  uint32_t sessionNavPacketCount = 0;
  uint32_t sessionRoutePacketCount = 0;
  uint32_t sessionRouteDuplicateCount = 0;
  uint32_t sessionGpsPacketCount = 0;
  uint32_t sessionSettingsPacketCount = 0;
