...
struct MapLiteStatus {
  bool experimentEnabled = map_lite_core::DEFAULT_EXPERIMENT_ENABLED;
  bool sdReady = false;
  bool hasProbe = false;
...
public:
  ...
  bool experimentEnabled() const { return currentStatus.experimentEnabled; }
...
private:
  ...
  void recordRenderStatus(uint32_t startedAtMs, uint32_t renderMs,
                          ...
                          bool budgetExceeded);
  bool renderPolygonRecords(SdFile &file, DisplayRound &display,
